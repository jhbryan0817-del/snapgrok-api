...
export async function getBillingHistory(
  token: string,
): Promise<{ billingEnabled: boolean; payments: BillingPayment[] }> {
  return billingRequest<{ billingEnabled: boolean; payments: BillingPayment[] }>(
    "/api/billing/history",
    token,
  );
}
...
export async function reactivateBillingMembership(
  token: string,
  plan: "plus" | "ultra",
): Promise<{
  planId: "plus" | "ultra";
