  ...
  return (
    <main className="info-page privacy-policy-page">
      ...
      <section className="policy-hero shell" aria-labelledby="privacy-policy-title">
        ...
        <p>
          This preview explains how the current SneakSolve product handles
          information. A final policy will be published before commercial
          billing launches.
        </p>
        ...
        <div className="policy-content">
          <section id="information">
            ...
            <ul>
              ...
              <li>
                During the billing test, plan, subscription, checkout, and
                question-usage records are processed for designated tester
                accounts. Payment details are collected by Lemon Squeezy, not
                by SneakSolve.
              </li>
            </ul>
          </section>
          ...
          <section id="sharing">
            ...
            <p>
              ...
              Lemon Squeezy for test checkout, subscription, and payment
          ...
          <section id="retention">
            ...
            <p>
              ...
              charges; signed webhook payloads are retained temporarily for
              audit and replay protection. Limited operational or security
              records may also be kept when reasonably necessary. Detailed
              retention periods will be finalized before commercial launch.
            </p>
          </section>
          ...
          <section id="changes">
            ...
            <p>
              ...
              include a new update date. A dedicated privacy contact method
      ...
      <aside className="policy-draft-note shell">
        ...
        <p>
          ...
          before subscriptions or the affiliate program become available.
        </p>
      </aside>
    </main>
  );
