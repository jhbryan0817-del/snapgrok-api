...
test("approved landing copy is present", () => {
  ...
  assert.match(page, /Get <BrandName \/>/);
  assert.match(
    page,
    /<BrandName \/> analyzes on-screen multiple-choice questions and delivers[\s\S]*answers instantly, without pulling you away from your tab\./,
  );
