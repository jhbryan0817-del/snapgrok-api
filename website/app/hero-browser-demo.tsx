    ...
    >
      ...
      <div className="browser-demo-frame demo-loop">
        <div className="browser-demo-chrome" aria-hidden="true">
          ...
          <div className="browser-demo-tab">Cell biology · Practice set</div>
          ...
          <div className="browser-demo-toolbar">
            ...
            <span className="toolbar-confirmation-pulse" />
          </div>
        </div>
        ...
        <div className="browser-demo-page">
          <div className="demo-question-card">
            ...
            <h2>Which organelle produces most of the cell&apos;s usable energy?</h2>
          ...
          <div className="demo-confirmation" aria-live="polite">
