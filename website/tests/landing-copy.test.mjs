...
test("approved landing copy is present", () => {
  ...
  assert.match(page, /Get for free/);
  assert.match(
    page,
    /Zenaian analyzes on-screen multiple-choice questions and delivers[\s\S]*answers instantly, without pulling you away from your tab\./,
  );
