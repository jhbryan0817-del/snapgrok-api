...
const config = {
  ...
  whopPlusLegacyPlanIds: new Set(["plan_oldplus123456"]),
  whopPlusProductId: "prod_plus123456",
  whopUltraPlanId: "plan_ultra123456",
  whopUltraLegacyPlanIds: new Set(["plan_oldultra123456"]),
  whopUltraProductId: "prod_ultra123456",
};

test("current and legacy plan IDs are recognized during plan transitions", () => {
  assert.deepEqual(acceptedWhopPlanIds(config), [
    "plan_plus123456",
    "plan_oldplus123456",
    "plan_ultra123456",
    "plan_oldultra123456",
  ...
  const selected = chooseEffectiveSubscription(
    ...
    [{
      id: "old-plus-sub",
      providerPlanId: "plan_oldplus123456",
  ...
  assert.equal(selected.planId, "plus");
});
