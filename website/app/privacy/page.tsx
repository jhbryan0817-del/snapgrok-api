    ...
    <main className="info-page privacy-policy-page">
      ...
      <aside className="policy-draft-note shell">
        ...
        <p>
          ...
          operator&apos;s full identity and address, confirm applicable retention
          periods and international-transfer mechanisms, and review notices
          required in each launch market.
        </p>
      </aside>
    </main>
  );
