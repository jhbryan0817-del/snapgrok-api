    ...
    return (
      <main className="account-page account-page-loading">
        ...
        <div className="account-loading-mark account-loading-centered">
          <BrandLogo compact />
          <span>Loading your <BrandName /> account…</span>
        </div>
      </main>
    );
  }
    ...
    <BillingStatusProvider>
      <main className="account-page">
        ...
        <section className="account-welcome">
          <div>
            <span className="section-kicker">YOUR <BrandName /> ACCOUNT</span>
        ...
        <section className="account-settings-section" aria-labelledby="account-settings-title">
          <div className="account-settings-heading">
            ...
            <p>Changes are handled securely through Clerk and apply to your <BrandName /> session.</p>
          </div>
