...
export default function HomePage() {
  return (
    <main id="top" className="landing-page">
      ...
      <section id="receive-answers" className="features-panel explore-panel shell reveal" data-animate aria-labelledby="explore-title">
        <div className="features-heading">
          <span className="section-kicker">BUILT AROUND YOUR WORKFLOW</span>
          <h2 id="explore-title">Explore Zenaian before you begin</h2>
