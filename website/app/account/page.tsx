  ...
  if (!isSignedIn) {
    return (
      <AuthShell
        ...
        title={
          mode === "sign-up"
            ? "Create your account. Keep every session secure."
            : "Welcome back. Pick up where you left off."
        }
        description={
          mode === "sign-up"
            ? "Create one secure identity for the SneakSolve website, Chrome extension, and analysis API."
            : "Sign in on the website, then reopen the SneakSolve extension to sync your authenticated session."
        }
        mode={mode}
      >
        {mode === "sign-up" ? (
  ...
  return (
    <main className="account-page">
      ...
      <header className="account-header">
        ...
        <nav className="account-header-nav" aria-label="Account navigation">
      ...
      <section className="account-summary-grid" aria-label="Account overview">
        <article>
          ...
          <div>
            ...
            <p>Reopen the SneakSolve popup after signing in or changing sessions.</p>
          </div>
        </article>
        <article>
