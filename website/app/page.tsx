      ...
      <section className="features-panel study-intelligence-panel shell reveal" data-animate aria-labelledby="study-intelligence-title">
        ...
        <div className="feature-grid study-intelligence-grid">
          <article className="feature-card study-speed-card interactive-card">
            ...
            <div className="memorization-flow workflow-flowchart" aria-label="Manual workflow takes five steps over two rows; Zenaian takes two steps">
              <div className="flowchart-path flowchart-path-manual">
                ...
                <div className="flowchart-lines">
                  <div className="flowchart-line">
                    <p>Screenshot</p><i aria-hidden="true">→</i><p>Switch screen</p><i aria-hidden="true">→</i><p>Paste and ask</p>
                  </div>
                  <div className="flowchart-turn" aria-hidden="true">↓</div>
                  <div className="flowchart-line flowchart-line-second">
                    <p>Confirm</p><i aria-hidden="true">→</i><p>Return</p>
                  </div>
                </div>
              </div>
          ...
          <article className="feature-card study-model-card interactive-card">
            ...
            <div className="benchmark-visual" aria-label="xAI-reported Grok 4.5 real-world software engineering benchmarks">
              ...
              <section className="benchmark-chart" aria-labelledby="token-efficiency-title">
                <div className="benchmark-heading">
                  <strong id="token-efficiency-title">SWE Bench Pro efficiency</strong>
                  <span>average output tokens · lower is better</span>
                </div>
                <div className="benchmark-row benchmark-row-grok"><span>Grok 4.5</span><i><b className="bar-24" /></i><em>15.9k</em></div>
                <div className="benchmark-row"><span>Opus 4.8</span><i><b className="bar-100" /></i><em>67.0k</em></div>
              </section>
            </div>
