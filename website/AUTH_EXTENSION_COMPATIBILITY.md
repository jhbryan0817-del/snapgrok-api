...
The website sends authenticated plan, checkout, and customer-portal requests
to the Render API. It does not send screenshot-analysis requests. The Chrome
...
does not change that capture flow. Extension v5.1.6 additionally answers one
...
The pricing page can request a server-created test checkout, but the website
