    ...
    <main id="top" className="landing-page">
      ...
      <section className="hero shell" aria-labelledby="hero-title">
        <div className="hero-copy reveal reveal-first" data-animate>
          ...
          <p className="hero-description">
            <BrandName /> analyzes on-screen multiple-choice questions and delivers
      ...
      <section className="stats-panel shell reveal" data-animate aria-label="Zenaian usage statistics">
        <article className="stat-item">
          ...
          <div className="stat-line">
            ...
            <div>
              <h2>Active Users</h2>
              <p>Trusting <BrandName /> every day</p>
            </div>
          </div>
        </article>
      ...
      <section id="features" className="features-panel shell reveal" data-animate aria-labelledby="features-title">
        <div className="features-heading">
          ...
          <h2 id="features-title">Make <BrandName /> work your way.</h2>
      ...
      <section id="privacy" className="privacy-panel shell reveal" data-animate aria-labelledby="privacy-title">
        ...
        <div className="privacy-content">
          ...
          <p className="privacy-intro">
            <BrandName /> is designed to keep your captured questions temporary,
          ...
          <div className="privacy-list">
            <PrivacyItem icon={<TrashIcon />} title="Screenshots are not stored">
              ...
              your device or on the <BrandName /> server.
            </PrivacyItem>
