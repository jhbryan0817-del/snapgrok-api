SNEAKSOLVE MCQ ASSISTANT V5.1.0
...
- Unlabeled choices are mapped by display order: first A, then B, C, D, and E.
...
Reload at chrome://extensions. Confirm version 5.1.0 and the expected ID above.
