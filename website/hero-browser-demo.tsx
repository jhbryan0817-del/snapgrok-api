    ...
    >
      ...
      <div className="browser-demo-frame demo-loop">
        <div className="browser-demo-chrome" aria-hidden="true">
          ...
          <div className="browser-demo-address">zenaian.com/use-example</div>
        ...
        <div className="browser-demo-page">
          ...
          <div className="demo-shortcut" aria-label="Control Shift Z keyboard shortcut">
            ...
            <div>
              ...
              <b>+</b>
              <kbd className="demo-key-z">Z</kbd>
            </div>
          </div>

          <p className="demo-illustration-note">
            Illustration only &mdash; no screen-swiping animation in real use.
          </p>
