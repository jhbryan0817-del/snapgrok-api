# Zenaian website v6.11.0 deployment
...
After deployment, hard-refresh the site and verify the hero's three icon
states, the processing-first Receive your answers panel, the A-and-C hover
tooltip, both shortcut selectors, the local-only context Save confirmation,
the two-row manual flowchart, the benchmark graphs, and one supporting page.
Then smoke-test sign-in and pricing status. Extension v5.3.0 does not need to
be repackaged or reinstalled.
