...
entitlement authority. Website v6.10.0 remains compatible with the currently
deployed API v5.8.1 and extension v5.3.0; neither needs to be redeployed for
this website-only release.
