# Zenaian website v6.15.0 deployment

Deploy this website together with API v6.0.2 and extension v5.4.0. Deploy and
...
View my data and Download JSON. A server failure now includes a safe error code
and request reference that can be matched to Render logs. Review
