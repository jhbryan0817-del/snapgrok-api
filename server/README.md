...
After deployment, `/api/health` must report version `6.0.2`,
`privacyControls: true`, and `privacyReady: true`. Complete one authenticated
View Data and Download JSON smoke test before treating the release as healthy.
