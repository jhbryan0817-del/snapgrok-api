...
const heroAnswerBadges = [
  { icon: "/zenaian-icons/hero/result-a128.png", label: "Answer A", position: "badge-a" },
  { icon: "/zenaian-icons/hero/result-b128.png", label: "Answer B", position: "badge-b" },
  { icon: "/zenaian-icons/hero/result-c128.png", label: "Answer C", position: "badge-c" },
  { icon: "/zenaian-icons/hero/result-d128.png", label: "Answer D", position: "badge-d" },
  { icon: "/zenaian-icons/hero/result-e128.png", label: "Answer E", position: "badge-e" },
  { icon: "/zenaian-icons/hero/result-multi-2128.png", label: "Two answers", position: "badge-multi-two" },
  { icon: "/zenaian-icons/hero/result-multi-3128.png", label: "Three answers", position: "badge-multi-three" },
  { icon: "/zenaian-icons/hero/processing128.png", label: "Processing", position: "badge-processing" },
  { icon: "/zenaian-icons/hero/result-inconclusive128.png", label: "Inconclusive", position: "badge-inconclusive" },
  { icon: "/zenaian-icons/hero/result-error128.png", label: "Error", position: "badge-error" },
] as const;
...
export default function HomePage() {
  return (
    <main id="top" className="landing-page">
      ...
      <section className="hero shell" aria-labelledby="hero-title">
        <div className="hero-copy reveal reveal-first" data-animate>
          ...
          <p className="hero-description">
            <span>Zenaian analyzes your multiple-choice questions.</span>
            <span>Get instant answers without leaving your tab.</span>
          </p>
        ...
        <div className="hero-visual-stage hero-media-intro">
          <div className="hero-badge-field" aria-hidden="true">
            {heroAnswerBadges.map((badge) => (
              <span className={`hero-state-badge ${badge.position}`} key={badge.position} title={badge.label}>
          ...
          <figure className="product-illustration" aria-labelledby="illustration-caption">
            ...
            <div className="hero-product-screen">
              <img
                src="/zenaian-how-it-works-v2.png"
                loading="eager"
                decoding="async"
                fetchPriority="high"
              ...
              />
              <div className="hero-answer-options" aria-label="Interactive answer preview">
                <span className="hero-answer-option option-a"><b>A</b><em>Venus</em></span>
                <span className="hero-answer-option option-b"><b>B</b><em>Mars</em></span>
                <span className="hero-answer-option option-c"><b>C</b><em>Jupiter</em></span>
                <span className="hero-answer-option option-d"><b>D</b><em>Neptune</em></span>
              </div>
              <span className="hero-answer-shine" aria-hidden="true" />
              <span className="hero-magnifier-motion" aria-hidden="true" />
            </div>
      ...
      <section className="stats-panel shell reveal" data-animate aria-label="Zenaian usage statistics">
      ...
      <section className="memorization-panel shell reveal" data-animate aria-labelledby="memorization-title">
        ...
        <div className="memorization-flow" aria-label="A faster review workflow">
          ...
          <div className="review-track review-track-manual">
            <span>Manual</span><p>Screenshot</p><i /> <p>Switch</p><i /> <p>Ask</p><i /> <p>Return</p>
          </div>
          <div className="review-track review-track-zenaian">
            <span>Zenaian</span><p>Capture</p><i /> <p>Confirm</p><i /> <p>Continue</p>
          </div>
        </div>
      </section>
