      ...
      <section className="hero shell" aria-labelledby="hero-title">
        <div className="hero-copy">
          ...
          <p className="hero-description">
            ...
            without pulling you away from the question on screen.
          </p>
        ...
        <figure className="product-illustration" aria-labelledby="illustration-caption">
          ...
          <img
            ...
            alt="A difficult electromagnetic-fields question on a browser screen, captured with the Ctrl Shift A shortcut, with SneakSolve displaying answer A near the extension icon."
          />
      ...
      <section id="privacy" className="privacy-panel shell" aria-labelledby="privacy-title">
        ...
        <div className="privacy-content">
          ...
          <p className="privacy-intro">
            SneakSolve is designed to keep your captured questions temporary,
          ...
          <div className="privacy-list">
            <PrivacyItem icon={<TrashIcon />} title="Screenshots are not stored">
              ...
              your device or in the SneakSolve server.
            </PrivacyItem>
