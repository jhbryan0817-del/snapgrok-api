...
The hero uses one ten-second demonstration timeline: the default Z remains
through the deliberately slower capture sweep and illustration notice,
followed by the Processing and answer B states. The account's Clerk
