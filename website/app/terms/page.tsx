      ...
      <section className="policy-layout shell">
        ...
        <div className="policy-content">
          ...
          <section id="plans">
            ...
            <p>
              One paid plan may be active on an account at a time. Canceling
              renewal does not end the period already paid for, and a different
              paid plan cannot be purchased on that account until the current
              paid period expires. There is no in-period upgrade or downgrade,
              no free trial, and no proration or credit. A customer who needs a
              different paid plan immediately may use a separate account. Payments
              are non-refundable except where a refund is required by applicable
              law. A failed, reversed, refunded, disputed, or charged-back payment
              may remove the affected entitlement immediately, with access falling
              back to Free.
            </p>
          </section>
