SNEAKSOLVE MCQ ASSISTANT V5.1.7
...
V5.1.7 VISUAL CHANGE
- The processing state now uses the website's purple square three-dot design
  at the standard 16, 32, 48, and 128 pixel Chrome icon sizes.
- All extension logic and every other state icon remain unchanged.
...
- The account page can request one read-only installation ping. It is restricted
  to https://www.sneaksolve.com and returns only installed state and version.
...
Reload at chrome://extensions. Confirm version 5.1.7 and the expected ID above.
