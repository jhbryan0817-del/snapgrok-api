  ...
  return (
    <main>
      <header className="site-header">
        <a className="brand" href="#top" aria-label="SnapGrok home">
      ...
      <section className="hero" id="top">
        ...
        <div className="hero-copy">
          ...
          <p className="hero-lede">
            SnapGrok turns any visible multiple-choice question into a quiet,
          ...
          <div className="hero-actions">
            ...
            <span className="platform-note">
              <span className="chrome-mark" aria-hidden="true" /> Built for Chrome
            </span>
          </div>
        ...
        <div className="hero-visual" aria-label="SnapGrok product interface preview">
          <div className="browser-card">
            <div className="browser-topbar">
              ...
              <div className="toolbar-icons">
                <span />
                <img src="/snapgrok-icons/result-a.png" alt="SnapGrok answer A in the Chrome toolbar" />
              </div>
            </div>
          ...
          <div className="extension-panel">
            <div className="extension-header">
              <img src="/snapgrok-icons/default.png" alt="" />
              <div><strong>SnapGrok</strong><span>MCQ capture assistant</span></div>
            ...
            <div className="result-preview">
              <span><Icon src="/snapgrok-icons/result-a.png" /><small>Single</small></span>
              <span><Icon src="/snapgrok-icons/result-multi.png" /><small>Multiple</small></span>
              <span><Icon src="/snapgrok-icons/result-inconclusive.png" /><small>Unclear</small></span>
              <span><Icon src="/snapgrok-icons/processing.png" /><small>Working</small></span>
            </div>
          </div>
          <div className="floating-note">
            <Icon src="/snapgrok-icons/result-a.png" />
        ...
        <div className="flow-grid">
          ...
          <article>
            ...
            <div className="step-visual thinking-visual">
              <Icon src="/snapgrok-icons/processing.png" alt="Processing" />
              <div><i /><i /><i /></div>
            </div>
            <h3>Think</h3>
            <p>Your instruction and image are sent for one request while SnapGrok works quietly.</p>
          </article>
          <article>
            <span className="step-number">03</span>
            <div className="step-visual answer-visual">
              <Icon src="/snapgrok-icons/result-a.png" alt="Answer A" />
              <span>4 sec</span>
            </div>
            <h3>Answer</h3>
        ...
        <div className="feature-grid">
          ...
          <article className="feature-card result-feature">
            ...
            <div className="multi-answer-stage" aria-label="Hover demonstration for a multiple-answer result">
              ...
              <div className="multi-hover-demo" tabIndex={0} aria-describedby="multi-answer-tooltip">
                <Icon src="/snapgrok-icons/result-multi.png" alt="Two correct answers" />
                <div className="answer-tooltip" id="multi-answer-tooltip" role="tooltip">
                  <span>Selected answers</span>
                  <strong>A · C</strong>
                </div>
              </div>
              <div className="result-state state-a"><Icon src="/snapgrok-icons/result-a.png" alt="Single answer" /></div>
              <div className="result-state state-unclear"><Icon src="/snapgrok-icons/result-inconclusive.png" alt="Inconclusive" /></div>
            </div>
          </article>
          ...
          <article className="feature-card instruction-feature">
            ...
            <div className="feature-copy">
              ...
              <p>Write a custom instruction once. SnapGrok sends it alongside each screenshot so the response follows the format and approach you want.</p>
            </div>
          </article>
        </div>
      </section>
      ...
      <section className="privacy-section" id="privacy" aria-labelledby="privacy-title">
        <div className="privacy-copy">
          ...
          <p>SnapGrok is built around a simple rule: process the current request without building a history of what you captured.</p>
        </div>
