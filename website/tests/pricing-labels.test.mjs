...
test("pricing labels reflect the single-paid-plan policy", () => {
  ...
  assert.equal(planActionLabel("ultra", "plus", "Choose Ultra"), "Switch to Ultra");
...
test("every paid-plan transition is a renewal cancellation flow", () => {
