  ...
  return (
    <main className="pricing-page">
      ...
      <section className="pricing-launch-note shell" aria-label="Billing availability">
        <div>
          <strong>Secure checkout powered by Whop.</strong>
          <p>
            One paid plan can be active per account. Cancel renewal and use
            the remainder of that paid period before choosing another plan.
          </p>
        </div>
