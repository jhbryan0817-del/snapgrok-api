    ...
    <main>
      ...
      <section className="hero" id="top">
        ...
        <div className="hero-copy">
          ...
          <div className="hero-actions">
            <a className="primary-cta" href="/sign-up">
        ...
        <div className="hero-visual" aria-label="SneakSolve product interface preview">
          <div className="browser-card">
            <div className="browser-topbar">
              ...
              <div className="address-bar">
                <span>lock</span> study.example.com
              </div>
              <div className="toolbar-icons">
                <span />
                <img
                  src="/sneaksolve-icons/result-a.png"
                  alt="SneakSolve answer A in the Chrome toolbar"
                />
              </div>
            </div>
            <div className="question-sheet">
              ...
              <div className="answer-row selected">
                <b>A</b>
                <span>The observed value supports the hypothesis.</span>
              </div>
              <div className="answer-row">
                <b>B</b>
                <span>The variables show no meaningful relationship.</span>
              </div>
              <div className="answer-row">
                <b>C</b>
                <span>The sample size invalidates every conclusion.</span>
              </div>
              <div className="selection-corners" aria-hidden="true">
                <i />
                <i />
                <i />
                <i />
          ...
          <div className="extension-panel">
            <div className="extension-header">
              ...
              <div>
                ...
                <span>MCQ capture assistant</span>
              </div>
            ...
            <div className="panel-section">
              ...
              <div className="capture-option">
                ...
                <div>
                  <strong>Visible tab</strong>
                  <small>Capture the whole visible webpage.</small>
                </div>
                <kbd>Ctrl ⇧ A</kbd>
              </div>
              <div className="capture-option">
                ...
                <div>
                  ...
                  <small>Drag over only the question you need.</small>
                </div>
                <kbd>Ctrl ⇧ X</kbd>
              </div>
            </div>
            <div className="result-preview">
              ...
              <span>
                <Icon src="/sneaksolve-icons/result-multi.png" />
                <small>Multiple</small>
              </span>
              <span>
                <Icon src="/sneaksolve-icons/result-inconclusive.png" />
                <small>Unclear</small>
              </span>
              <span>
                <Icon src="/sneaksolve-icons/processing.png" />
                <small>Working</small>
              </span>
            </div>
          </div>
          <div className="floating-note">
            ...
            <span>
              ...
              <small>Shown for 4 seconds</small>
            </span>
          </div>
        </div>
      </section>
      ...
      <section className="flow-section" id="how-it-works" aria-labelledby="flow-title">
        <div className="section-intro">
          <span className="section-kicker">WHY SNEAKSOLVE</span>
          <h2 id="flow-title">
            From question to answer
            <br />in three quiet steps.
          </h2>
        ...
        <div className="feature-grid">
          ...
          <article className="feature-card result-feature">
            <div className="feature-copy">
              ...
              <p>
                Multiple-answer MCQs are fully supported. Hover over the toolbar icon to reveal the exact answer choices.
              </p>
            </div>
            <div className="multi-answer-stage" aria-label="Hover demonstration for a multiple-answer result">
              ...
              <div className="result-state state-a">
                <Icon src="/sneaksolve-icons/result-a.png" alt="Single answer" />
              </div>
              <div className="result-state state-unclear">
                <Icon src="/sneaksolve-icons/result-inconclusive.png" alt="Inconclusive" />
              </div>
            </div>
          </article>
          ...
          <article className="feature-card instruction-feature">
            ...
            <div className="feature-copy">
              ...
              <p>
                Write a custom instruction once. SneakSolve sends it alongside each screenshot so the response follows the format and approach you want.
              </p>
            </div>
          </article>
        </div>
      ...
      <section className="privacy-section" id="privacy" aria-labelledby="privacy-title">
        <div className="privacy-copy">
          ...
          <p>
            SneakSolve is built around a simple rule: process the current request without building a history of what you captured.
          </p>
        </div>
        <div className="privacy-points">
          <div>
            <span>01</span>
            <p>Screenshots and answers are not saved.</p>
          </div>
          <div>
            <span>02</span>
            <p>Only the current image and the instruction you wrote are sent.</p>
          </div>
          <div>
            <span>03</span>
            <p>The temporary request document closes when the operation ends.</p>
          </div>
        </div>
        <div className="privacy-mark" aria-hidden="true">
          <img src="/sneaksolve-icons/default.png" alt="" />
          <div className="privacy-ring one" />
          <div className="privacy-ring two" />
        </div>
      </section>

      <section className="pricing-section" id="pricing" aria-labelledby="pricing-title">
        <span className="section-kicker">PRICING</span>
        <h2 id="pricing-title">Simple plans. Clear access.</h2>
        <p>
          Final SneakSolve plan details will be published here before the public launch.
        </p>
      </section>
