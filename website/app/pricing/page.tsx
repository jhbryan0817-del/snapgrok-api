...
const plans = [
  ...
  },
  {
    ...
    features: [
      "40x the Free monthly capacity",
      "Full-screen and selected-area capture",
      "Custom shortcuts and AI context",
    ],
    cta: "Choose Plus",
    featured: true,
  },
  ...
  return (
    <main className="pricing-page">
      ...
      <section className="pricing-hero shell" aria-labelledby="pricing-title">
        ...
        <h1 id="pricing-title">Choose how far you want to go.</h1>
        <p>
      ...
      <section className="pricing-grid shell" aria-label="SneakSolve plans">
        {plans.map((plan) => (
          ...
          >
            ...
            <Link
              className={plan.featured ? "pricing-cta pricing-cta-primary" : "pricing-cta"}
      ...
      <section className="pricing-launch-note shell" aria-label="Billing availability">
        <div>
          <strong>Plans are being prepared for launch.</strong>
          <p>
            Pricing is published for preview. Paid-plan activation will become
            available when SneakSolve billing launches.
          </p>
        </div>
        <Link href="/account?mode=sign-up">Create your account</Link>
      </section>
    </main>
  );
}
