SNEAKSOLVE MCQ ASSISTANT V5.0.1
...
- The API verifies the token, exact extension origin, and live Clerk session
  before work and again before returning an answer.

SECURITY AND PRIVACY
- Only the Render API, production Clerk host, and canonical website are in
  host_permissions.
...
Reload at chrome://extensions. Confirm version 5.0.1 and the expected ID above.
