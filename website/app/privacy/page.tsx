  ...
  return (
    <main className="info-page privacy-policy-page">
      ...
      <section className="policy-hero shell" aria-labelledby="privacy-policy-title">
        <span className="section-kicker">PRIVACY AT <BrandName /></span>
        <h1 id="privacy-policy-title">Privacy Policy</h1>
        <p>
          This working draft explains how the current <BrandName /> product and
      ...
      <section className="policy-layout shell">
        ...
        <div className="policy-content">
          <section id="information">
            ...
            <p>
              <BrandName /> processes the information needed to provide the
          ...
          <section id="use">
            ...
            <p>
              ...
              answers, maintain reliability, and protect <BrandName /> against
          ...
          <section id="sharing">
            ...
            <p>
              <BrandName /> relies on service providers to operate: Clerk for
          ...
          <section id="retention">
            ...
            <p>
              <BrandName /> is designed not to save captured screenshots as
          ...
          <section id="security">
            ...
            <h2>Security</h2>
            <p>
              <BrandName /> uses encrypted network connections, authenticated API
