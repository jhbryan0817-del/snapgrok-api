          ...
          <article className="feature-card study-speed-card interactive-card">
            ...
            <div className="study-speed-stage">
              <div
                ...
                role="img"
                aria-label="Manual workflow illustration repeatedly switching between a question tab and an AI tab"
              >
                <span className="study-motion-label">Manual workflow</span>
                <div className="motion-browser" aria-hidden="true">
                  <div className="motion-browser-tabs">
                    <span className="manual-tab-question">Question</span>
                    <span className="manual-tab-assistant">AI tool</span>
                  </div>
                  <div className="motion-browser-screen">
                    <div className="manual-screen manual-screen-question">
                      <i>Question 08</i>
                      <strong>Which option is correct?</strong>
                      <span>A</span><span>B</span><span>C</span>
                    </div>
                    <div className="manual-screen manual-screen-assistant">
                      <i>New conversation</i>
                      <div className="manual-paste-preview" />
                      <span className="manual-prompt-line" />
                      <b>Ask</b>
                    </div>
                  </div>
                </div>
                <p>Copy. Switch. Paste. Return.</p>
              </div>
              ...
              <div className="memorization-flow workflow-flowchart" aria-label="Manual workflow takes five vertical steps; Zenaian takes two vertical steps">
                <div className="flowchart-path flowchart-path-manual">
                  ...
                  <div className="flowchart-lines">
                    <ol className="flowchart-steps">
                      <li className="flowchart-step"><span aria-hidden="true">1</span><p>Screenshot</p></li>
                      <li className="flowchart-step"><span aria-hidden="true">2</span><p>Switch screen</p></li>
                      <li className="flowchart-step"><span aria-hidden="true">3</span><p>Paste and ask</p></li>
                      <li className="flowchart-step"><span aria-hidden="true">4</span><p>Confirm</p></li>
                      <li className="flowchart-step"><span aria-hidden="true">5</span><p>Return</p></li>
                    </ol>
                  </div>
                </div>
                <div className="flowchart-path flowchart-path-zenaian">
                  ...
                  <div className="flowchart-lines">
                    <ol className="flowchart-steps">
                      <li className="flowchart-step"><span aria-hidden="true">1</span><p>Capture</p></li>
                      <li className="flowchart-step"><span aria-hidden="true">2</span><p>Confirm</p></li>
                    </ol>
                  </div>
                </div>
              </div>
              ...
              <div
                ...
                role="img"
                aria-label="Zenaian illustration capturing a question and displaying answer B without switching tabs"
              >
                <span className="study-motion-label">Zenaian workflow</span>
                <div className="motion-browser" aria-hidden="true">
                  <div className="zenaian-motion-toolbar">
                    ...
                    <div className="zenaian-motion-icon">
                      ...
                      <i className="zenaian-motion-processing"><img src="/zenaian-icons/processing.png" alt="" /></i>
                ...
                <p>Capture. Answer. Keep moving.</p>
              </div>
            </div>
          </article>
          ...
          <div className="privacy-content">
            ...
            <div className="privacy-list">
              <PrivacyItem icon={<TrashIcon />} title="Screenshots are not stored">
                <span className="privacy-sentence-line">Captured images are processed transiently and are not saved</span>
                <span className="privacy-sentence-line">on your device or on the Zenaian server.</span>
              </PrivacyItem>
              <PrivacyItem icon={<EyeOffIcon />} title="Designed to keep process minimal">
                <span className="privacy-sentence-line">The extension communicates through its toolbar icon</span>
                <span className="privacy-sentence-line">so you can stay focused on the page in front of you.</span>
              </PrivacyItem>
            </div>
          </div>
        </div>
