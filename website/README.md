...
The hero icon cycles through Z, processing, and B states every four seconds,
including an opacity-only fallback for reduced-motion visitors. The benchmark
panel focuses on the enlarged SWE Marathon comparison.
